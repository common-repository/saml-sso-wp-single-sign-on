...
function kwsso_feedback_deactivation_modal() {
    ...
    echo    '</div>
                ...
                <div class="kwsso-feedback-footer flex mt-kw-6">
                    <button class="kw-button primary" type="submit" value="Deactivate and Submit">
                    ...
                    <div class="kwsso-feedback-skip-div">
                        <a id="kwsso-feedback-skip-feedback" class="">Skip</a>
                    </div>
                </div>
            </form>
        </div>
