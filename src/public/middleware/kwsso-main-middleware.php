<?php
/**
 * Loads the tab kwsso_layout and initializes other controllers.
 *
...
use KWSSO_CORE\Src\Utility\KWSSO_PluginSubTabs;

$kwsso_current_user = wp_get_current_user();
$middleware_path = KWSSO_PLUGIN_DIR . 'src/public/middleware/';
$admin_service   = KWSSO_AdminActionService::instance();
