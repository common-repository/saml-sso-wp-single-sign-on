 ...
 *
 * @package keywoot-saml-sso/controller
 */
...
$on_select_idp_page      =  kwsso_check_if_sp_configured()  ? 'none' : '';//phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.NonceVerification.Recommended -- Reading GET parameter from the URL for checking the form name, doesn't require nonce verification.
